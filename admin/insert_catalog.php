            ...
            <div class="ui stacked segment">
              ...
              ?>
                <form action="admin.php?act=insert_catalog" method="POST" onsubmit="return validateForm()">
                    ...
                    <label>Ưu tiên</label>
                    <input type="text" id="prioritize_catalog" name="prioritize_catalog" placeholder="Ưu tiên sản phẩm 1 là có còn 0 là không"></input>
                    <label>Hiển thị</label>
                    <input type="text" id="display_catalog" name="display_catalog" placeholder="Hiển thị sản phẩm 1 là có còn 0 là không" ></input>
