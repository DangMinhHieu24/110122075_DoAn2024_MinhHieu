        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
              <div class="ui blue ribbon icon label">Thông tin nhà cung cấp</div>
              <br><br>
                    ...
                    echo '
                      <tr>
                        ...
                        <td>'.$supplier['sup_id'].'</td>
                         ...
                         <td>
                         <div class="frame1">
                         <button class="button-update"><a class="change-a" href="admin.php?act=updateform_supplier&id='.$supplier['sup_id'].'">Cập nhật</a></button>
                         <button class="button-delete"><a class="change-a" href="admin.php?act=del_supplier&id='.$supplier['sup_id'].'">Xoá</a></button> 
                         </div>
                          </td>
                      </tr>
                        ';
