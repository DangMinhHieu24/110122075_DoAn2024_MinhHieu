        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
              <div class="ui blue ribbon icon label">Thông tin về danh sách sản phẩm / dịch vụ</div>
              <br><br>
                    ...
                    echo '
                      <tr>
                        ...
                        <td>'.$catalog['id_catalog_k'].'</td>
                         ...
                         <td>
                         <div class="frame1">
                         <button class="button-update"><a class="change-a" href="admin.php?act=updateform_catalog&id='.$catalog['id_catalog_k'].'">Cập nhật</a></button>
                         <button class="button-delete"><a class="change-a" href="admin.php?act=del_catalog&id='.$catalog['id_catalog_k'].'">Xoá</a></button> 
                         </div>
                          </td>
                      </tr>
                        ';
              ...
              <div>
              <button class="button-insert" ><a class="change-a" href="admin.php?act=insert_catalog&id='1'">Nhập</a></button>
              </div>
            </div>
            <!-- END DATATABLE -->
          </div>
