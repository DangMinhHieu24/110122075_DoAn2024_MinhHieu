            ...
            <div class="header-navbar">
                <div class="header-brand">
                    <a href="fashionApp.php?act=home">
                        <img style="  width: 231px; height: 52px;" src="../assets/images/logo/MH-logo.png"
                            alt="Site Logo" />
                    </a>
                </div>
                <div class="header-main-nav">
                    ...
                    <nav class="mainmenu-nav">
                      ...
                      ?>
                            ...
                            <li><a href="fashionApp.php?act=about">THÔNG TIN</a></li>
                        </ul>
                    </nav>
                    <!-- End Mainmanu Nav -->
                </div>
                    ...
                    <ul class="action-list">
                        <li class="axil-search d-xl-block d-none">
                            <input type="search" class="placeholder product-search-input" name="search2" id="search2"
                                value="" maxlength="128" placeholder="Bạn đang tìm gì?" autocomplete="off" />
                        ...
                        if(isset($_SESSION['username'])&&($_SESSION['username']!=""))
                        {
                          echo '
                          <div class="login-btn">
                          <li><a class="axil-btn btn-bg-primary" style="text-align: center;" href="fashionApp.php?act=account_user">Tài khoản</a></li>
                          </div>
                          </ul>
                          <div class="login-btn">
