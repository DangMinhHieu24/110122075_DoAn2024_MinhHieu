                                    ...
                                    if ($detail_product[0]["quantity"] == 0) {
                                        echo '
                                            <ul class="product-meta">
                                                <li style="color: red;"><i class="fal fa-times"></i>Hết hàng</li>
                                                <li style="color: red;"><i class="fal fa-times"></i>'.$detail_product[0]["quantity"].' sản phẩm còn trong kho</li>
                                            </ul>
                                        ';
                                    } else {
                                        echo '
                                            <ul class="product-meta">
                                                <li style="color: Blue;"><i class="fal fa-check"></i>'.$detail_product[0]["quantity"].' sản phẩm còn trong kho</li>
                                            </ul>
                                        ';
                                    }
                                    ...
                                    <div class="product-variations-wrapper">
                                        ...
                                        <div class="product-variation product-size-variation">
                                            ...
                                            <ul class="range-variant">
                                                ...
                                                <li onclick="highlightSize(this)">X</li>
