            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="main-slider-content">
                        <span class="subtitle"><i class="fas fa-fire"></i>Mua ngay kẻo hết 🌟</span>
                        <h1 class="title">Ở đâu có ý chí, ở đó có con đườnga</h1>
                        <!-- <div class="shop-btn">
                  <a
                                        ...
                                        <div class="inner">
                                            ...
                                            <ul class="cart-action">
                                                <li class="select-option">
                                                    <a " href="fashionApp.php?act=detail_product&id='.$pd['id_product'].'">Mua ngay</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="axil-product product-style-one">
                                        <div class="thumbnail">
                                            ...
                                            <div class="product-hover-action">
                                                <ul class="cart-action">
                                                    <li class="select-option">
                                                        <a href="fashionApp.php?act=detail_product&id='.$result['id_product'].'">Mua ngay</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
